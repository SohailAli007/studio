...
const menuData: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Asian Chicken Salad", price: "$53.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "asian salad chicken", description: "Grilled chicken, mixed greens, mandarin oranges, and a sesame ginger dressing.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Asian Chicken Salad food dish")}` },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Vegetable Stir-Fry", price: "$52.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "vegetable stir fry", description: "A medley of fresh vegetables stir-fried in a savory sauce with tofu or chicken.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Vegetable Stir-Fry food dish")}` },
      { name: "Lamb Chops", price: "$58.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "lamb chops grilled", description: "Grilled lamb chops with a mint glaze, served with roasted vegetables.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Lamb Chops food dish")}`},
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Lasagna Bolognese", price: "$53.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "lasagna bolognese meat", description: "Layers of pasta, rich meat sauce, béchamel, and cheese, baked to perfection.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Lasagna Bolognese food dish")}`}
    ],
  },
  {
    name: "Desserts",
    items: [
      ...
      { name: "New York Cheesecake", price: "$52.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "new york cheesecake", description: "Creamy New York style cheesecake with a graham cracker crust and berry coulis.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("New York Cheesecake food dish")}` },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Garlic Mashed Potatoes", price: "$20.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "mashed potatoes garlic", description: "Creamy mashed potatoes infused with roasted garlic.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Garlic Mashed Potatoes food dish")}`}
    ]
  }
];
    ...
    if (selectedItem === null && typeof scrollPositionRef.current === 'number') {
      ...
      if (scrollableMain) {
        requestAnimationFrame(() => {
          if (typeof scrollPositionRef.current === 'number') { // Check again inside rAF
