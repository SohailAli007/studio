...
const menuData: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Filet Mignon", price: "$45.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "filet mignon steak", description: "A tender and juicy cut of beef, cooked to your liking, with mashed potatoes.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Filet Mignon food dish")}` },
      { name: "Chicken Piccata", price: "$48.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "chicken piccata pasta", description: "Sautéed chicken breast with a lemon butter and caper sauce, served over pasta.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Chicken Piccata food dish")}` },
      ...
      { name: "Lamb Chops", price: "$58.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "grilled lamb chops", description: "Grilled lamb chops with a mint glaze, served with roasted vegetables.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Lamb Chops food dish")}`},
      { name: "Beef Stroganoff", price: "$54.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "beef stroganoff noodles", description: "Tender beef strips in a creamy mushroom sauce, served over egg noodles.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Beef Stroganoff food dish")}`}
    ],
  },
  {
    name: "Pasta and Risotto",
    items: [
      { name: "Spaghetti Carbonara", price: "$50.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "spaghetti carbonara", description: "Spaghetti with a creamy egg sauce, pancetta, Pecorino Romano, and black pepper.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Spaghetti Carbonara food dish")}` },
      { name: "Fettuccine Alfredo", price: "$45.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "fettuccine alfredo", description: "Fettuccine pasta tossed in a rich and creamy Alfredo sauce with Parmesan cheese.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Fettuccine Alfredo food dish")}` },
      { name: "Linguine with Clam Sauce", price: "$48.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "linguine clam sauce", description: "Linguine pasta with a flavorful white wine and garlic clam sauce.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Linguine with Clam Sauce food dish")}` },
      { name: "Wild Mushroom Risotto", price: "$52.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "mushroom risotto", description: "Creamy Arborio rice risotto with a variety of wild mushrooms and Parmesan.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Wild Mushroom Risotto food dish")}` },
      { name: "Penne alla Vodka", price: "$49.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "penne alla vodka", description: "Penne pasta in a creamy tomato and vodka sauce.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Penne alla Vodka food dish")}` },
      { name: "Lasagna Bolognese", price: "$53.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "lasagna bolognese slice", description: "Layers of pasta, rich meat sauce, béchamel, and cheese, baked to perfection.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Lasagna Bolognese food dish")}`}
    ],
  },
  {
    name: "Desserts",
    items: [
      { name: "Tiramisu", price: "$50.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "tiramisu slice", description: "Classic Italian coffee-flavored dessert with ladyfingers, mascarpone, and cocoa.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Tiramisu food dish")}` },
      { name: "Chocolate Lava Cake", price: "$45.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "chocolate lava cake", description: "Warm chocolate cake with a molten chocolate center, served with vanilla ice cream.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Chocolate Lava Cake food dish")}` },
      { name: "Crème Brûlée", price: "$48.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "creme brulee", description: "Rich custard base topped with a layer of hardened caramelized sugar.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Crème Brûlée food dish")}` },
      ...
      { name: "Apple Crumble", price: "$47.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "apple crumble dessert", description: "Warm spiced apples topped with a buttery crumble, served with caramel sauce.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Apple Crumble food dish")}` },
      { name: "Panna Cotta", price: "$46.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "panna cotta dessert", description: "Italian cooked cream dessert, often flavored with vanilla and served with fruit.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Panna Cotta food dish")}`}
    ],
  },
  {
    name: "Beverages",
    items: [
      ...
      { name: "Orange Juice", price: "$15.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "orange juice glass", description: "Freshly squeezed orange juice.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Orange Juice drink")}` },
      { name: "Iced Lemon Tea", price: "$12.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "iced lemon tea", description: "Refreshing iced tea with a hint of lemon.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Iced Lemon Tea drink")}` },
      { name: "Espresso", price: "$18.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "espresso coffee", description: "Strong and aromatic Italian espresso.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Espresso coffee")}` },
  ...
  },
  {
    name: "Sides",
    items: [
      { name: "French Fries", price: "$15.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "french fries basket", description: "Crispy golden French fries, lightly salted.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("French Fries food dish")}` },
      { name: "Onion Rings", price: "$18.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "onion rings", description: "Battered and deep-fried onion rings.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Onion Rings food dish")}` },
      { name: "Side Salad", price: "$20.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "side garden salad", description: "Mixed greens with cherry tomatoes, cucumber, and choice of dressing.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Side Salad food dish")}` },
      { name: "Steamed Vegetables", price: "$22.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "steamed vegetables mix", description: "A healthy mix of seasonal steamed vegetables.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Steamed Vegetables food dish")}` },
      { name: "Garlic Mashed Potatoes", price: "$20.00", imageUrl: "https://placehold.co/300x200.png", imageHint: "garlic mashed potatoes", description: "Creamy mashed potatoes infused with roasted garlic.", imageSearchUrl: `https://www.google.com/search?tbm=isch&q=${encodeURIComponent("Garlic Mashed Potatoes food dish")}`}
    ]
  }
];
